...
nohup python main.py --n_GPUs 3 --scale 2 --patch_size 96 --batch_size 32 --data_test Set5 --loss 1\*SmoothL1 --lr 2e-4 --n_colors 3 --optimizer ADAM --skip_threshold 1e6 --epochs 1000 --decay 500-800-900-950 --res_connect 1acb3 --upsampling PixelShuffle --srarn_up_feat 64 --depths 6+6+6+6+6+6 --dims 180+180+180+180+180+180 --model SRARNV6 --save ../srarn_v6/srarn_v6_ps_g12_x2 --reset > ../srarn_v6/v6_ps_g12_x2.log 2>&1 &
# Test:
# python main.py --n_GPUs 3 --scale 2 --patch_size 96 --batch_size 32 --data_test Set5 --loss 1\*SmoothL1 --lr 2e-4 --n_colors 3 --optimizer ADAM --skip_threshold 1e6 --epochs 1000 --res_connect 1acb3 --upsampling PixelShuffle --srarn_up_feat 64 --depths 6+6+6+6+6+6 --dims 180+180+180+180+180+180 --model SRARNV6 --save ../srarn_v6/srarn_v6_ps_g12_x2 --pre_train ../srarn_v6/srarn_v6_ps_g12_x2/model/model_best.pt --test_only --save_result --inf_switch
