...
# run example for v9bL_Nrst_D1acb3_x2: ./scripts/train_srarn_v9.sh train 0,1 1 bL n 2 48 ms skip 1acb3 batch befln nolr  # 38.257 v8  # PixelShuffleNOAct+BicubicAdd
...
if [ $size = "bL" ]; then  # model_b use PixelShuffle upsampling with no activate layer, same as SwinIR
