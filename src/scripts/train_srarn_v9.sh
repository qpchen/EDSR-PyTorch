...
# ################### test ######################
# for batch/v9l2_1acb3_D1acb3_x2: ./scripts/train_srarn_v9.sh train 0 1 l2 b 2 48 ms 1acb3 1acb3 batch no nolr  # retraining shen a100
...
# ############## model_l #############
  ...
  options="--epochs 1000 --decay 500-800-900-950 --upsampling PixelShuffle --no_act_ps --srarn_up_feat 150 --depths 8+8+8+8+8+8+8+8 --dims 150+150+150+150+150+150+150+150 --batch_size 32"
# ############## model_s #############
elif [ $size = "s" ]; then
